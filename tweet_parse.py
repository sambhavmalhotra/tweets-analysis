...
tweets_data_path = './alltweets2019.txt'
...
tweets = pd.DataFrame()
tweets['user_name'] = map(lambda tweet: tweet['user_name'] if tweet['user_name'] != None else None, tweets_data)
...
tweets['gardens'] = tweets['text'].apply(lambda tweet: word_in_text(r'(gardensbythebay|gardenbythebay|gardens|bay)', tweet))
tweets['universal'] = tweets['text'].apply(lambda tweet: word_in_text(r'(universalstudiossingapore|universalstudiosingapore|universalstudios|universalstudio)', tweet))
...
parks = ['gardens', 'universal', 'lego']
tweets_by_park = [tweets['gardens'].value_counts()[True], tweets['universal'].value_counts()[True], tweets['lego'].value_counts()[True]]
...
ax.set_title('Tweet Frequency: gardens vs. universal vs. lego', fontsize=10, fontweight='bold')
