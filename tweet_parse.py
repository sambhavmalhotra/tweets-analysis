...
tweets_data_path = './data/alltweets2019.txt'
...
tweets['gardens'] = tweets['text'].apply(
    lambda tweet: word_in_text(r'(gardensbythebay|gardenbythebay|gardens|bay)', tweet))
tweets['universal'] = tweets['text'].apply(
    lambda tweet: word_in_text(r'(universalstudiossingapore|universalstudiosingapore|universalstudios|universalstudio)',
                               tweet))
...
tweets_by_park = [tweets['gardens'].value_counts()[True], tweets['universal'].value_counts()[True],
                  tweets['lego'].value_counts()[True]]
